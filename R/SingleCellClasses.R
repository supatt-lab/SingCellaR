...
#' The followings are slots which store information.
#' 
...
#' The TargetSeq Class is the extended SingCellaR class
#' The TargetSeq object stores all of information required for TARGET-Seq analyses.
#' The followings are slots which store information.
...
#' @name TargetSeq
#' @rdname TargetSeq
#' @aliases TargetSeq-class
#' @exportClass TargetSeq

setClass(
  Class="TargetSeq",contain="SingCellaR",
  representation(
...
#' SingCellaR_Int Class is the extended SingCellaR class
#' SingCellaR_Int object stores all of information required for multiple samples integration analyses.
#' The followings are slots which store information.
...
#' @name SingCellaR_Int
#' @rdname SingCellaR_Int
#' @aliases SingCellaR_Int-class
#' @exportClass SingCellaR_Int
